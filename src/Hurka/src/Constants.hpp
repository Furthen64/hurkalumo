...
const int NR_GRIDS_HEIGHT = 32;            // Seems fine to change this to 20x20,  32x32 or 64x64 , havent made 20x40 to work tho... like a rectangle
const int NR_GRIDS_WIDTH  = 32;
